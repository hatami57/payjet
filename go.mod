...
// microjet sub-packages are unpublished local modules in the sibling repo.
// These replace directives let payjet build against them without publishing.
// To release payjet for external `go get`, tag the microjet modules and drop
// these replaces.
replace (
	...
	github.com/hatami57/microjet/http => ../microjet/http
	github.com/hatami57/microjet/messaging => ../microjet/messaging
	github.com/hatami57/microjet/postgres => ../microjet/postgres
	github.com/hatami57/microjet/types => ../microjet/types
	github.com/hatami57/microjet/utils => ../microjet/utils
)
