module github.com/majid/payjet
...
require (
	...
	github.com/hatami57/microjet/gormx/postgres v0.41.0
	github.com/hatami57/microjet/gormx/sqlite v0.41.0
	github.com/hatami57/microjet/host v0.41.0
	github.com/hatami57/microjet/httpx v0.41.0
	github.com/shopspring/decimal v1.4.0
	github.com/stretchr/testify v1.11.1
	gorm.io/gorm v1.31.1
)

// payjet builds against a local ../microjet checkout via these replace
// directives so it tracks in-progress framework changes. To release payjet for
// external `go get` against the published microjet modules, drop these replaces.
replace (
	...
	github.com/hatami57/microjet/gormx/postgres => ../microjet/gormx/postgres
	...
	github.com/hatami57/microjet/messaging/nats => ../microjet/messaging/nats
